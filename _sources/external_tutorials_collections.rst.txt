...
- `Python for Chemists course <https://github.com/GDChCICTeam/python-for-chemists>`_ by the `GDCh/CIC <https://www.gdch.de/cic>`_ team: Crash-course introduction to Python for natural scientists
